      ...
      <section className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        {mineRows.length === 0 ? (
          ...
          <ul className="mt-8 space-y-3">
            {mineRows.map((r) => (
              <li key={r.id} className="flex flex-wrap items-center gap-3 rounded-2xl border border-zinc-200 bg-white p-4 transition hover:border-zinc-300 hover:shadow-sm sm:gap-4">
        ...
        <div className="mt-14">
          ...
          {publicRows.length === 0 ? (
            ...
            <ul className="mt-5 space-y-3">
              {publicRows.map((r) => (
                <li key={r.id} className="flex flex-wrap items-center gap-4 rounded-2xl border border-zinc-200 bg-white p-4 transition hover:border-zinc-300 hover:shadow-sm">
                  <Thumb url={r.imageUrl} />
